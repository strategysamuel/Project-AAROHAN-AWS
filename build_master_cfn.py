...
with open('cloudformation-ecs-networking-new.yml', 'r', encoding='utf-8') as f:
...
with open('cloudformation-ecs-networking.yml', 'w', encoding='utf-8') as f:
    yaml.dump(template, f, Dumper=AwsDumper, default_flow_style=False, sort_keys=False)
print("Built master CFN template")
